...
const Disclaimer = () => {
    ...
    const toggleDisclaimer = () => setIsExpanded(!isExpanded);
        ...
        <>
            <div
                ...
                className={`disclaimer-container ${
                    isMobile ? 'disclaimer-container--mobile' : 'disclaimer-container--desktop'
                } ${isDragging ? 'disclaimer-container--dragging' : ''}`}
                style={
                    isMobile || isDesktop
                        ? {
            ...
            >
                <div
                    className={`disclaimer-header ${
                        isMobile ? 'disclaimer-header--mobile' : 'disclaimer-header--desktop'
                    }`}
            ...
            {isExpanded && (
                <>
                    {/* Backdrop overlay */}
                    <div className='disclaimer-backdrop' onClick={() => setIsExpanded(false)} />

                    {/* Floating modal content */}
                    <div
                        data-testid='dt_traders_hub_disclaimer'
                        className={`disclaimer-content ${
                            isMobile ? 'disclaimer-content--mobile' : 'disclaimer-content--desktop'
                        }`}
                    >
                        <div className='disclaimer-text'>
                            ...
                            <p>
                                <strong>
                                    <Localize i18n_default_text='Please ensure you understand these risks:' />
                                </strong>
                            </p>
